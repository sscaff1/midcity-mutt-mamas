export function meta() {
  return [
    { title: 'Contact Us - Mid City Mutt Mamas' },
    {
      name: 'description',
      content:
        'Get in touch with Mid City Mutt Mamas to learn more about adoption, fostering, or volunteering opportunities.',
    },
  ];
}
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          <div className="bg-gray-50 p-6 rounded-lg shadow-sm hover:shadow-md transition-shadow">
            ...
            <div className="flex gap-4">
              <a
                href="https://facebook.com/midcitymutt"
                target="_blank"
              ...
              <a
                href="https://instagram.com/midcitymutt"
                target="_blank"
                rel="noopener noreferrer"
                className="inline-block px-4 py-2 bg-[#11b7b3] text-white rounded-md hover:bg-[#0fa39f] transition-colors"
              >
          ...
          <div className="bg-gray-50 p-6 rounded-lg shadow-sm hover:shadow-md transition-shadow">
            ...
            <p className="text-gray-600 mb-4">
              We regularly participate in adoption events throughout New Orleans. Check our social media for upcoming
              events where you can meet our dogs in person.
            </p>
            <a
              href="/events"
              className="inline-block px-4 py-2 bg-[#11b7b3] text-white rounded-md hover:bg-[#0fa39f] transition-colors"
