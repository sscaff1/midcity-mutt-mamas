export function meta() {
  return [
    { title: 'Adopt - Mid City Mutt Mamas' },
    {
      name: 'description',
...
function Adopt() {
  return (
    <div className="space-y-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          <div className="bg-gray-50 p-6 rounded-lg shadow-sm hover:shadow-md transition-shadow">
            ...
            <p className="text-gray-600">
              Schedule a meet and greet with your potential new family member. This helps ensure it&apos;s a good match
          ...
          <div className="bg-gray-50 p-6 rounded-lg shadow-sm hover:shadow-md transition-shadow">
            ...
            <p className="text-gray-600">
              We&apos;ll schedule a home visit to ensure your living situation is suitable for your potential new family
              member.
            </p>
          </div>
          <div className="bg-gray-50 p-6 rounded-lg shadow-sm hover:shadow-md transition-shadow">
      ...
      {/* Adoption Fees */}
      <section className="bg-white rounded-lg p-8 shadow-sm">
        <h2 className="text-3xl font-bold mb-8 text-gray-800">Adoption Fees</h2>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="bg-gray-50 p-6 rounded-lg shadow-sm hover:shadow-md transition-shadow">
            <h3 className="text-xl font-semibold mb-3 text-gray-800">Puppies</h3>
            <p className="text-3xl font-bold text-[#11b7b3] mb-4">$350</p>
            <p className="text-gray-600">Includes spay/neuter, vaccinations, microchip, and initial vet care</p>
          </div>
          <div className="bg-gray-50 p-6 rounded-lg shadow-sm hover:shadow-md transition-shadow">
            <h3 className="text-xl font-semibold mb-3 text-gray-800">Adult Dogs</h3>
            <p className="text-3xl font-bold text-[#11b7b3] mb-4">$250</p>
            <p className="text-gray-600">Includes spay/neuter, vaccinations, microchip, and initial vet care</p>
          </div>
          <div className="bg-gray-50 p-6 rounded-lg shadow-sm hover:shadow-md transition-shadow">
            <h3 className="text-xl font-semibold mb-3 text-gray-800">Senior Dogs</h3>
            <p className="text-3xl font-bold text-[#11b7b3] mb-4">$150</p>
            <p className="text-gray-600">Includes spay/neuter, vaccinations, microchip, and initial vet care</p>
          </div>
        </div>
      </section>
      ...
      <section className="bg-white rounded-lg p-8 shadow-sm">
        <div className="text-center">
          ...
          <p className="text-xl text-gray-600 mb-8 max-w-2xl mx-auto">
            View our available dogs and start your journey to finding the perfect companion. Have questions? We&apos;re
            here to help!
          </p>
