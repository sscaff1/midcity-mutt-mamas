export function meta() {
  return [
    { title: 'Foster - Mid City Mutt Mamas' },
    {
      name: 'description',
      content:
        'Learn about our fostering program and how you can help provide temporary homes for dogs in need at Mid City Mutt Mamas.',
    },
  ];
}
